...
public class SpeedStreaming {
    ...
    public static void main(String[] args) {
        ...
        // Extract the value from the input and put it into the "speed" topic
        statsStream
                .filter((key, value) -> key != null && value != null)
                .mapValues(SpeedStreaming::extractSpeed)
                .to("speed");
    ...
    private static String extractSpeed(String input) {
